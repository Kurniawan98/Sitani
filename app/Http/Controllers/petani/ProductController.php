...
class ProductController extends Controller
{
    public function index()
    {
        ...
        return view('petani.product.index',$data);
    }
    ...
    public function tambah()
    {
        ...
        return view('petani.product.tambah',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')){
            ...
            return redirect()->route('petani.product')->with('status','Berhasil Menambah Produk Baru');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('petani.product.edit',$data);
    }
    ...
    public function update($id,Request $request)
    {
        ...
        return redirect()->route('petani.product')->with('status','Berhasil Mengubah Kategori');
    }
    ...
    public function delete($id)
    {
        ...
        Product::destroy($id);
        Storage::delete('public/'.$prod->image);
        return redirect()->route('petani.product')->with('status','Berhasil Mengahapus Produk');
    }
}
