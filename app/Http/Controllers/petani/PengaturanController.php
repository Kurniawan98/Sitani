...
class PengaturanController extends Controller
{
    public function aturalamat()
    {
        ...
        return view('petani.pengaturan.alamat',$data);
    }
    ...
    public function ubahalamat($id)
    {
        ...
        $data['provinces'] = Province::all();
        $data['id'] = $id;
        return view('petani.pengaturan.ubahalamat',$data);
    }
    ...
    public function simpanalamat(Request $request)
    {
        ...
        return redirect()->route('petani.pengaturan.alamat')->with('status','Berhasil Mengatur Alamat');
    }
    ...
    public function updatealamat($id,Request $request)
    {
        ...
        return redirect()->route('petani.pengaturan.alamat')->with('status','Berhasil Mengubah Alamat');
    }
}
