            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <input id="no_telp" type="number" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" value="{{ old('no_telp') }}" required autocomplete="no_telp" placeholder="No Handphone">
                    @error('no_telp')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                @enderror
                  ...
                  <div class="form-group">
                              ...
                              <div class="form-group">
                                  {{-- <label for="name" class="col-md-4 col-form-label">Pilih Login</label> --}}
                                      <select  class="form-control" name="role" id="" onchange="onChange()">
