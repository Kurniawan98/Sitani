...
<div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('user.produk.update',['id' => $produk->id]) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="image" value="{{ $produk->image}}">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                ...
                                {{-- Produk Biasa--}}
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success text-right">Ubah Produk</button>
                                </div>
                              </form>
                             </div> 
                        </div>
