                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.berita.update',['id' => $berita->id]) }}" method="POST">
                                ...
                                <input type="text" class="form-control" name="judul" value="{{ $berita->name }}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputUsername1">Tanggal</label>
                                <input type="date" class="form-control" name="tanggal" value="{{ $berita->name }}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputUsername1">Isi</label>
                                <input type="text" class="form-control" name="isi" value="{{ $berita->name }}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputUsername1">Gambar</label>
                                <input type="file" class="form-control" name="gambar" value="{{ $berita->name }}">
                                </div>
