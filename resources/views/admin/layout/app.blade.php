            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin Sitani</p>
                </div>
              </a>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Sitani</span>
              ...
              <a class="nav-link" data-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic1">
               ...
               <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link {{ Request::path() === 'admin/kategoriharga' ? 'active' : '' }}" href="{{ route('admin.kategoriharga') }}"">Kategori Harga Pangan</a></li>
                  <li class="nav-item"><a class="nav-link {{ Request::path() === 'admin/datakategoriharga' ? 'active' : '' }}" href="{{ route('admin.datakategoriharga') }}""> Data Harga Pangan</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
