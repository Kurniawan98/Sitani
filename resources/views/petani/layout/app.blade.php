            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">petani</p>
                </div>
              </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  ...
                  <span class="text-secondary text-small">petani</span>
                </div>
                <i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
              </a>
            </li>
            <li class="nav-item {{ Request::path() === 'petani' ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('petani.pelanggan') }}">
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.product') }}">Produk</a></li>
                  <li class="nav-item"> <a class="nav-link {{ Request::path() === 'petani/categories' ? 'active' : '' }}" href="{{ route('petani.categories') }}">Kategori</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi') }}">Pesanan Baru</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi.perludicek') }}">Perlu Di Cek</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi.perludikirim') }}">Perlu Di Kirim</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi.dikirim') }}">Barang Di Kirim</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi.selesai') }}">Selesai</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.transaksi.dibatalkan') }}">Dibatalkan</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('petani.pengaturan.alamat') }}"> Alamat</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('petani.rekening') }}">No Rekening</a></li>
                </ul>
              </div>
            </li>
          </ul>
