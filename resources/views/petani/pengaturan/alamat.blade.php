              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('petani.pengaturan.simpanalamat') }}" method="POST">
                                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table>
                              ...
                              <small><a href="{{ route('petani.pengaturan.ubahalamat',['id' =>  $alamat->id]) }}">Klik untuk mengubah alamat toko</a></small>
                        </div>
                    </div>
                  </div>
                </div>
