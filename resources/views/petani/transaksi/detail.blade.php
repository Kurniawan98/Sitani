                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="p-2"><a href="{{ route('petani.transaksi.konfirmasi',['id' => $order->id]) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi Telah Bayar</a><br>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2">
                            <form action="{{ route('petani.transaksi.inputresi',['id' => $order->id]) }}" method="POST">
                                @csrf
